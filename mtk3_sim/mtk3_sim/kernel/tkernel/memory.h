...
#else	// POINTER_SIZE_64BIT

/*
 * Compensation for aligning "&areaque" position to 2 bytes border
 */
#define AlignIMACB(imacb)	( (IMACB*)((UD)(imacb) & ~0x00000001UD) )
 ...
 *	AreaQue uses the lower 1 bit for flag.
 */
#define ROUNDSZ		( sizeof(QUEUE) )	/* 16 bytes */
#define ROUND(sz)	( ((UW)(sz) + (UW)(ROUNDSZ-1)) & ~(UW)(ROUNDSZ-1) )
...
#define setAreaFlag(q, f)   ( (q)->prev = (QUEUE*)((UD)(q)->prev |  (UD)(f)) )
#define clrAreaFlag(q, f)   ( (q)->prev = (QUEUE*)((UD)(q)->prev & ~(UD)(f)) )
#define chkAreaFlag(q, f)   ( ((UD)(q)->prev & (UD)(f)) != 0 )

#define Mask(x)		( (QUEUE*)((UD)(x) & ~AREA_MASK) )
#define Assign(x, y)	( (x) = (QUEUE*)(((UD)(x) & AREA_MASK) | (UD)(y)) )
/*
 * Area size
 */
#define AreaSize(aq)	( (VB*)(aq)->next - (VB*)((aq) + 1) )
#define FreeSize(fq)	( (D)((fq) + 1)->prev )

#endif	// POINTER_SIZE_64BIT
