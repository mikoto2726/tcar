...
#else
	/* Align top with 4 byte unit alignment for IMACB */
	knl_lowmem_top = (void *)(((UD)knl_lowmem_top + 3) & ~0x00000003UL);
	knl_imacb = (IMACB*)knl_lowmem_top;
	knl_lowmem_top = (void *)((UD)knl_lowmem_top + sizeof(IMACB));

	/* Align top with 8 byte unit alignment */
	knl_lowmem_top = (void *)(((UD)knl_lowmem_top + 7) & ~0x00000007UL);
	top = (QUEUE*)knl_lowmem_top;
	knl_imacb->memsz = (W)((UD)knl_lowmem_limit - (UD)knl_lowmem_top - sizeof(QUEUE)*2);
#endif
