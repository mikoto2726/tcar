...
EXPORT INT usermain(void)
{
    ...
    /* タスク生成情報 */
    led_bz_ctsk.tskatr = TA_HLNG | TA_RNG3; /* タスク属性 */
    led_bz_ctsk.task = led_task;
    led_bz_ctsk.itskpri = 10; /* タスク起動時優先度 */
    led_bz_ctsk.stksz = 1024; /* スタックサイズ */

    led_tskid = tk_cre_tsk(&led_bz_ctsk);
